            ...
            <div class="invoice-container">
                <div class="invoice-inner">
                    ...
                    <div class="driver-info">
                        <div class="info-line"><strong>:</strong> {{ $data['driver_name'] }}</div>
                        <div class="info-line"><strong>:</strong> {{ $invoice['address'] }}</div>
                        <div class="info-line"><strong>:</strong> {{ $invoice['mobile'] }}</div>
                    </div>
