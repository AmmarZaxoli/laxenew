            ...
            <div class="row align-items-center">
                <div class="col-12">
                    ...
                    <p class="mb-0 text-white">مرحباً بك مجدداً, <span
                            style="font-weight: 600;color:#ffffff">{{ auth('account')->user()->name }}</span> إليكم ما
                        يحدث اليوم.</p>
                </div>
            </div>
        </div>
        ...
        <div class="row mb-3 mb-md-4">
            <div class="col-12">
                <div class="quick-actions">
                    <a href="{{ route('accountdrivers.create') }}" class="quick-action-btn">
                        <i class="bi bi-qr-code-scan"></i>
                        <span>مسح ضوئي للفواتير</span>
                    </a>
                    <a href="{{ route('selling.create') }}" class="quick-action-btn">
                    ...
                    <a href="{{ route('returnsell.create') }}" class="quick-action-btn">
                        <i class="bi bi-receipt"></i>
                        <span>إرجاع الفواتير</span>
                    </a>
                    <a href="{{ route('offers.edit') }}" class="quick-action-btn">
                        <i class="bi bi-gift"></i>
                        <span>تعديل العروض</span>
                    </a>
                    <a href="{{ route('accounting.create') }}" class="quick-action-btn">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg mb-2 mb-md-0">
                <div class="card stat-card h-100">
                    <div class="card-body p-2 p-md-3 text-center text-sm-start">
                        ...
                        <h3 class="card-value">{{ number_format($weekSales) }} د.ع</h3>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg mb-2 mb-md-0">
                <div class="card stat-card h-100">
                    <div class="card-body p-2 p-md-3 text-center text-sm-start">
                        ...
                        <h3 class="card-value">{{ number_format($totalprice) }} د.ع</h3>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg">
                <div class="card stat-card h-100">
                    <div class="card-body p-2 p-md-3 text-center text-sm-start">
                        ...
                        <h3 class="card-value">{{ number_format($totaldelete) }}</h3>
                    </div>
                </div>
            </div>
        </div>
