<div>
    <div class="container py-4">
        ...
        <!-- Add Product Form (shown when showAddForm is true) -->
        @if ($showAddForm)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" readonly
                                            wire:model.live="products.{{ $index }}.q_sold"
                                    ...
                                    <td>
                                        <input type="number" step="0.01"
                                            wire:model.live="products.{{ $index }}.buy_price"
                                            class="form-control text-center">
                                    </td>

                                    <td>
                                        <input type="date" wire:model.live="products.{{ $index }}.dateex"
                                            class="form-control">
                                    </td>
                                    <td>
            ...
            <div class="col-md-3">
                <div class="card h-100 border-0 shadow-sm">
                    <div class="card-body">
                        ...
                        <p class="card-text h4">{{ number_format($this->totalPrice) }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="card h-100 border-0 shadow-sm">
                    <div class="card-body">
                        ...
                        <p class="card-text h4">{{ number_format($this->afterDiscountTotalPrice) }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="card h-100 border-0 shadow-sm">
                    <div class="card-body">
                        ...
                        <p class="card-text h4">{{ number_format($this->residual) }}</p>
                    </div>
                </div>
            </div>
        </div>
