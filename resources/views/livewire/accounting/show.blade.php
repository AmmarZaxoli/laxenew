        ...
        <div class="container-fluid py-4">
            ...
            <div class="stats-grid" style="margin-top: 15px">
                ...
                <div class="stat-card expenses">
                    ...
                    <h6>عدد التوصيلات</h6>
                    <h3>{{ number_Format($paymenuser) }}</h3>
                </div>
                ...
                <div class="stat-card net-profit">
                    ...
                    <h6>صافي الربح</h6>
                    <h3>{{ number_format($totalProfitafterdiscount - $expense - $paymenuser) }}</h3>
                </div>
                ...
                <div class="stat-card discount">
                    ...
                    <h6>سندوق</h6>
                    <h3>{{ number_format($totalafterdiscount - $expense - $paymenuser) }}</h3>
                </div>
