        ...
        <div class="card h-100 shadow-sm border-0">
            ...
            <div class="card-body">
                <div class="text-center mb-3">
                    <h4 class="text-primary">الفاتورة #: {{ $num_invoice }}</h4>
                </div>
        ...
        <div class="col-md-6">
            <div class="card shadow-sm border-0 h-100">
                <div class="card-header bg-light d-flex justify-content-between align-items-center">
                    ...
                    <span class="badge bg-primary">{{ count($gitproducts) }} عناصر</span>
                </div>
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                @forelse ($gitproducts as $gitproduct)
                                    <tr class="align-middle">
                                        <td>{{ $gitproduct->name }}</td>
                                        <td class="text-center">{{ $gitproduct->code }}</td>
                                        <td class="text-center">
                                            <div
                                                class="quantity-control d-flex align-items-center justify-content-center">
                                                <!-- Increment Button -->
                                                <button wire:loading.attr="disabled"
                                                    wire:target="incrementProduct({{ $gitproduct->product_id }},{{ $gitproduct->price }})"
                                                    wire:click="incrementProduct({{ $gitproduct->product_id }},{{ $gitproduct->price }})"
                                                ...
                                                <!-- Decrement Button -->
                                                <button wire:loading.attr="disabled"
                                                    wire:target="decrementProduct({{ $gitproduct->product_id }},{{ $gitproduct->price }})"
                                                    wire:click="decrementProduct({{ $gitproduct->product_id }},{{ $gitproduct->price }})"
                                                    class="btn btn-quantity minus" @disabled($gitproduct->quantity <= 0)
                                                    title="إنقاص الكمية">
                                        ...
                                        <td class="text-center">{{ number_format($gitproduct->price) }}</td>
                                        <td class="text-center fw-bold">
                                            {{ number_format($gitproduct->price * $gitproduct->quantity) }}</td>
                                    </tr>
                                @empty
                                    <tr>
        ...
        <div class="col-md-6">
            <div class="card shadow-sm border-0 h-100">
                <div class="card-header bg-light d-flex justify-content-between align-items-center">
                    ...
                    <span class="badge bg-success">{{ count($gitoffers) }} عروض</span>
                </div>
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div
                                                ...
                                                <button wire:click="decrementOffer({{ $gitoffer['id'] }})"
                                        ...
                                        <td class="text-center fw-bold">
                                            {{ number_format($gitoffer['quantity'] * $gitoffer['price']) }}
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
                ...
                <div class="card-body p-3">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <span class="h4 mb-0 text-danger fw-bold">
                            {{ number_format((float) str_replace(',', '', $discount ?? 0)) }}
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-2">
                        ...
                        <span class="h4 mb-0 text-dark fw-bold">
                            {{ number_format((float) str_replace(',', '', $total_price_invoice) - (float) $discount) }}
                            <small class="text-muted fs-6">دينار</small>
                        </span>
                    </div>
                </div>
