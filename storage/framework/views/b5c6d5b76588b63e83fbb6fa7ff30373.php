...
$__html = app('livewire')->mount($__name, $__params, 'lw-492536674-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-492536674-1', $__slots ?? [], get_defined_vars());
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
    ...
    <script>
        ...
        \Livewire\store($this)->push('scripts', $__output, $__scriptKey)
    ?>
</div><?php /**PATH C:\Users\user\Desktop\laxe8-10 (4)\resources\views/livewire/drivers/invoice-controls/show.blade.php ENDPATH**/ ?>