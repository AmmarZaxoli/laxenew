...
<body>
    <div class="main-report">
        ...
        <?php $__currentLoopData = array_chunk($data['driverInvoices'], 30); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chunkIndex => $invoiceChunk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <!-- رأس التقرير -->
            ...
            <table class="invoice-table">
                ...
                <tbody>
                    <?php $__currentLoopData = $invoiceChunk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($index + 1 + ($chunkIndex * 30)); ?></td>
