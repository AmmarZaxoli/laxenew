                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-2 col-6">
                            ...
                            <input type="text" id="num_invoice" class="form-control" wire:model="num_invoice"
                                <?php if($this->invoicevisibale): ?> disabled <?php endif; ?> autocomplete="off">
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['num_invoice'];
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="col-md-4 col-6 position-relative" x-data @click.away="$wire.hideDropdown()">
                            ...
                            <input type="text" class="form-control me-2" wire:model.live="search"
                                ...
                                <?php if($invoicevisibale): ?> disabled <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($showDropdown && count($companys) > 0): ?>
                                <div class="dropdown-menu show"
                                    style="position: absolute; top: 110%; left: 0; right: 0;
                                           max-height: 200px; overflow-y: auto; z-index: 1000;">
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $companys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <button type="button" class="dropdown-item"
                                            wire:click="selectCompany(<?php echo e($company->id); ?>)">
                                            <?php echo e($company->companyname); ?>
                        ...
                        <div class="col-md-3 col-6 align-items-end" style="margin-top: 57px">
                            <button type="submit" class="btn btn-icon btn-outline-primary pulse-hover w-100"
                                ...
                                <?php if($this->invoicevisibale): ?> disabled <?php endif; ?>>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2122132976-0', $__slots ?? [], get_defined_vars());
...
<?php /**PATH C:\Users\PC\Desktop\laxe8-10 (2)\resources\views/livewire/add-invoices/insert.blade.php ENDPATH**/ ?>