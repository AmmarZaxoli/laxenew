...
<body>
    <div class="invoices-wrapper">
        <?php $__currentLoopData = $data['invoices']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="invoice-container <?php if(!$invoice['show_header']): ?> mt-top-page <?php endif; ?>">
        <div class="invoice-container <?php echo e($invoice['show_header'] ? 'first-page' : 'next-page'); ?>">
...
</html><?php /**PATH C:\Users\user\Desktop\laxe8-10 (4)\resources\views/print/multiprint.blade.php ENDPATH**/ ?>