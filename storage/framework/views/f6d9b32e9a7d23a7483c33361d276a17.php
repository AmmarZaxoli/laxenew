        ...
        <div class="data-table-container">
            ...
            <div class="table-responsive">
                <table class="modern-table">
                    <thead>
                        <tr>
                            ...
                            <th wire:click="sortBy('name')" style="cursor: pointer" class="text-leght">الاسم
                                <!--[if BLOCK]><![endif]--><?php if($sortColumn == 'name'): ?>
                            ...
                            <th wire:click="sortBy('code')" style="cursor: pointer" class="text-center">
                                الكود
                                <i class="ms-1">
                                    <!--[if BLOCK]><![endif]--><?php if($sortColumn == 'code'): ?>
                                        <!--[if BLOCK]><![endif]--><?php if($sortDirection == 'asc'): ?>
                                            <i class="bi bi-sort-alpha-down"></i> 
                                        <?php else: ?>
                                            <i class="bi bi-sort-alpha-down-alt"></i> 
                    ...
                    <tbody>
                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $filteredResults; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $filteredResult): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
...
<?php /**PATH C:\Users\Malta Computer\Desktop\laxe8-10 (4)\resources\views/livewire/accounting/showbuyproduct.blade.php ENDPATH**/ ?>