...
$__html = app('livewire')->mount($__name, $__params, 'lw-1271505950-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1271505950-1', $__slots ?? [], get_defined_vars());
            ...
            <div class="card border-0 shadow-sm h-100">
                ...
                <div class="card-body py-2 d-flex justify-content-between">
                    ...
                    <span class="fw-bold fs-6 text-success">
                        <?php echo e(number_format($invoices->count() * 1000 + $invoices->sum(fn($i) => $i->sell?->total_price_afterDiscount_invoice ?? 0))); ?>
                ...
                <div class="card-body py-2 d-flex justify-content-between bg-light rounded">
                    ...
                    <span class="fw-bold fs-6 text-primary">
                        <?php echo e(number_format($invoices->count())); ?>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td class="text-center align-middle"width="30px">
                                <?php if($invoice->customer?->waypayment): ?>
                            ...
                            <td class="text-center align-middle" width="30px">
                                <?php if($invoice->customer?->buywith): ?>
                                    <div class="modern-chip">
            ...
            <div class="modal-content shadow-lg">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <?php $__errorArgs = ['selectedDriverId'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php /**PATH C:\Users\user\Desktop\laxe8-10 (9)\resources\views\livewire\drivers\invoice-controls\show.blade.php ENDPATH**/ ?>