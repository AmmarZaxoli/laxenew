...
<head>
    ...
    <style>
        ...
        .icons-container {
            order: 3;
            text-align: right;
                transform: translateX(10px); /* Negative moves right in RTL */
    ...
    <div class="invoices-wrapper">
        <?php $__currentLoopData = $data['invoices']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="invoice-container">
                            ...
                            <div class="icons-container">
                                <div class="social-media">
                                    <div class="social-item">
                                        ...
                                        <svg style="font-size: 13px;color: #813434;"
                        ...
                        <div
                            style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 5mm; border-bottom: 1px solid #813434; padding-bottom: 1mm;">
                            <!-- Customer Info (right) -->
...
</html><?php /**PATH C:\Users\user\Desktop\laxe8-18\resources\views\print\multiprint.blade.php ENDPATH**/ ?>