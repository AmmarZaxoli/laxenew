...
$__html = app('livewire')->mount($__name, $__params, 'lw-4264083123-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-4264083123-1', $__slots ?? [], get_defined_vars());
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
    ...
    <script>
        ...
        \Livewire\store($this)->push('scripts', $__output, $__scriptKey)
    ?>
</div><?php /**PATH C:\Users\Malta Computer\Desktop\laxe8-19\resources\views/livewire/drivers/invoice-controls/show.blade.php ENDPATH**/ ?>