    ...
    <form wire:submit.prevent="update">
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" wire:model.defer="nameDriver"
                class="form-control <?php $__errorArgs = ['nameDriver'];
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" wire:model.defer="mobile" class="form-control <?php $__errorArgs = ['mobile'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-3 ">
            ...
            <input type="number" class="form-control <?php $__errorArgs = ['taxiprice'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" wire:model.defer="numcar" class="form-control <?php $__errorArgs = ['numcar'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php /**PATH C:\Users\user\Desktop\laxe8-10 (9)\resources\views\livewire\drivers\edit.blade.php ENDPATH**/ ?>