...
$__html = app('livewire')->mount($__name, $__params, 'lw-458098400-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-458098400-1', $__slots ?? [], get_defined_vars());
...
<?php echo $__env->make('layouts.index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PC\Desktop\New folder (6)\laxe8-12\resources\views\expenses\create.blade.php ENDPATH**/ ?>