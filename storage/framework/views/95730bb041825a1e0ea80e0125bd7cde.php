                                ...
                                <tr class="align-middle" style="cursor: pointer;"
                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="d-flex justify-content-center align-items-center gap-2">
                                            ...
                                            <a href="<?php echo e(route('invoices.edit', $invoice->id)); ?>" target="_blank"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Modal is open for invoice #<?php echo e($invoiceId); ?></p>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\Users\Malta Computer\Desktop\laxe8-19\resources\views/livewire/invoices/show.blade.php ENDPATH**/ ?>