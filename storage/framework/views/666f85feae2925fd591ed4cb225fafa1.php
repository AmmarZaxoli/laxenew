<div>
    <div class="container py-4">
        ...
        <div class="input-group mb-3">
            <input type="search" autocomplete="off" wire:model.live.debounce.500ms="search" 
                   class="form-control" placeholder="ابحث باسم المنتج أو الباركود...">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <td>
                                        <button wire:click="deleteConfirmation(<?php echo e($product['id']); ?>)"
...
</div><?php /**PATH C:\Users\PC\Desktop\laxe8-10\resources\views/livewire/add-invoices/edit.blade.php ENDPATH**/ ?>