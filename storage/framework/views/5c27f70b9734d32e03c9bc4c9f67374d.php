<div>
    ...
    <div class="container-fluid py-4">
        ...
        <div class="row g-3">
                ...
                <div class="row g-3">
                            ...
                            <div class="card-body p-0">
                                <div class="table-responsive" style="max-height: 400px;">
                                    <table class="table table-sm table-hover mb-0">
                                        ...
                                        <tbody>
                                            <?php $__empty_1 = true; $__currentLoopData = $driverInvoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <tr class="<?php echo e(in_array($invoice['num_invoice_sell'], $barcodes) ? 'table-success' : ''); ?>"
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <?php if(in_array($invoice['num_invoice_sell'], $barcodes)): ?>
                                                                <i
                    ...
                    <div class="col-md-6">
                        <div class="card border-success">
                            ...
                            <div class="card-body p-0">
                                <div class="table-responsive" style="max-height: 400px;">
                                    <table class="table table-sm table-hover mb-0">
                                        ...
                                        <tbody>
                                            <?php $__empty_1 = true; $__currentLoopData = $scannedInvoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <?php if(count($scannedInvoices) > 0): ?>
                                <div class="card-footer bg-white p-2">
                                    <small class="text-muted">
                                        <i class="bi bi-info-circle me-1"></i>
            ...
            <!-- Progress Bar -->
            <?php if($selectedDriverId && count($driverInvoices) > 0): ?>
                <div class="card mt-3">
                    <div class="card-body">
