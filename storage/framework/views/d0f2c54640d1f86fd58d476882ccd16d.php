...
$__html = app('livewire')->mount($__name, $__params, 'lw-210673855-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-210673855-1', $__slots ?? [], get_defined_vars());
...
<?php echo $__env->make('layouts.index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Malta Computer\Desktop\laxe8-20\resources\views/accounts/create.blade.php ENDPATH**/ ?>