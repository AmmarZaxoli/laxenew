                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $definitions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $definition): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="align-middle" style="cursor: pointer;"
                                ...
                                <td class="text-center">
                                    <?php if($definition->is_active === 'active'): ?>
...
<td class="text-center">
                                    <?php if($definition->delivery_type): ?>
                                        <span class="badge bg-success bg-opacity-10 text-success">
                                ...
                                <td class="text-center">
                                    <?php if($definition->image && file_exists(public_path('storage/' . $definition->image))): ?>
...
?>
                ...
                <!-- Pagination -->
                <?php echo e($definitions->links('pagination::bootstrap-5')); ?>
...
<?php /**PATH C:\Users\PC\Desktop\New folder (6)\laxe8-12\resources\views\livewire\definitions\show.blade.php ENDPATH**/ ?>