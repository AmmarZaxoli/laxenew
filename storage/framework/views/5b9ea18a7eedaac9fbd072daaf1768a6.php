            ...
            <div class="row g-6 w-100">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <div class="input-group">
                        <input type="text" id="phoneNumber" wire:model.live.debounce.500ms="phoneNumber" class="form-control"
                ...
                <div class="col-md-3 col-sm-12">
                    ...
                    <input type="date" id="from_date" wire:model.live="from_date" class="form-control">
                </div>

                <!-- To Date -->
                <div class="col-md-3 col-sm-12">
                    <label for="to_date" class="dashboard-title">إلى تاريخ</label>
                    <input type="date" id="to_date" wire:model.live="to_date" class="form-control">
                </div>

                <!-- Reset Button -->
                <div class="col-md-2 col-sm-12 d-flex align-items-end">
                    <button class="btn btn-secondary w-100" wire:click="resetSearch" 
                            <?php if(!$isFiltered): ?> disabled <?php endif; ?>>
                        إعادة تعيين
                    </button>
                </div>
            </div>
        ...
        <div class="table-wrapper">
            <!--[if BLOCK]><![endif]--><?php if(!empty($orders)): ?>
                <div class="p-3 bg-light border-bottom">
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($isFiltered): ?>
                ...
                <table class="orders-table">
                    ...
                    <tbody>
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $paginatedOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
