...
unset($__errorArgs, $__bag); ?>
                            ...
                            <?php if($showDropdown && count($companys) > 0): ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2121111482-0', $__slots ?? [], get_defined_vars());
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="align-middle">
                                        ...
                                        <td class="fw-medium " style="width: 350px"><?php echo e($product['name']); ?> </td>
            ...
            <?php endif; ?>
            <?php if(!empty($product) && is_array($product) && count($product)): ?>
...
<?php /**PATH C:\Users\user\Desktop\laxe8-10 (7)\resources\views\livewire\add-invoices\insert.blade.php ENDPATH**/ ?>