                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center">
                                            <button wire:click="view('<?php echo e($order['id']); ?>')" class="action-btn"
                                ...
                                <tbody>
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $modalProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e(number_format($product['total_price'])); ?></td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                                </tbody>
                            </table>
...
<?php /**PATH C:\Users\Malta Computer\Desktop\laxe8-10 (4)\resources\views/livewire/getAPI/show.blade.php ENDPATH**/ ?>