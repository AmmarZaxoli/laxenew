        ...
        <div class="dashboard-header">
            <div class="row g-6 w-100">
                ...
                <div class="col-md-4 col-sm-12">
                    <label for="searchPhone" class="dashboard-title">بحث برقم الهاتف</label>
                    <div class="input-group">
                        <input type="text" id="searchPhone" class="form-control" 
                               wire:model.debounce.500ms="searchPhone" 
                               placeholder="أدخل رقم الهاتف">
                        <button class="btn btn-outline-secondary" wire:click="applyFilters">
                ...
                <div class="col-md-3 col-sm-12">
                    <label for="startDate" class="dashboard-title">من تاريخ</label>
                    <input type="date" id="startDate" wire:model="startDate" class="form-control">
                </div>

                <!-- End Date -->
                <div class="col-md-3 col-sm-12">
                    <label for="endDate" class="dashboard-title">إلى تاريخ</label>
                    <input type="date" id="endDate" wire:model="endDate" class="form-control">
                </div>

                <!-- Filter Buttons -->
                <div class="col-md-2 col-sm-12 d-flex align-items-end">
                    <button class="btn btn-primary me-2" wire:click="applyFilters" style="white-space: nowrap;">
                        تطبيق البحث
                    </button>
                    <button class="btn btn-secondary" wire:click="resetFilters" style="white-space: nowrap;">
                        إعادة تعيين
                    </button>
                </div>
            </div>
        ...
        <div class="table-wrapper">
            <?php if(!empty($orders)): ?>
                ...
                <table class="orders-table">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $paginatedOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
